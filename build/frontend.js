...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/frontend.js");
/******/ })
/************************************************************************/
/******/ ({
...
window.addEventListener("DOMContentLoaded", function (event) {
  var wrappers = document.getElementsByClassName("eb-slider-wrapper");
  ...
  try {
    var _loop = function _loop() {
      ...
      var settings = JSON.parse(wrapper.getAttribute("data-settings"));
      var images = JSON.parse(wrapper.getAttribute("data-images"));
      var sliderContentType = wrapper.getAttribute("data-sliderContentType");
      var sliderType = wrapper.getAttribute("data-sliderType");
      var textAlign = wrapper.getAttribute("data-textAlign");
      var slider = createRef();
      render(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(react_slick__WEBPACK_IMPORTED_MODULE_2___default.a, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        ref: slider
      }, settings, {
        key: "".concat(settings.autoplay, "-").concat(settings.adaptiveHeight),
        className: "".concat(sliderType, " xxx")
