...
= 1.5.0 - 09/08/2026 =
* Fixed: PHP 8.1 – 8.5 deprecation notices in the font loader
* Fixed: WordPress version detection used a float cast, which misread two-digit minor versions
* Fixed: fatal error when build assets or the style-handler submodule are missing
* Improved: compatibility support with WordPress 7.0
